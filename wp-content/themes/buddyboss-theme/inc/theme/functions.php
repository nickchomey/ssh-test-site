...
function buddyboss_theme_scripts() {
	...
	wp_localize_script( 'buddyboss-theme-main-js', 'bs_data', apply_filters( 'buddyboss-theme-main-js-data', array(
		...
		'facebook_label'     => __( 'Share on Facebook', 'buddyboss-theme' ),
	        ...
	        if ( isset( $item->classes ) && is_array( $item->classes ) ) {
	            foreach ( $item->classes as $item_class ) {
		            ...
		            if ( ! bp_is_active( 'forums' ) && in_array( $item_class, $forums_array, true ) ) {
			            ...
			            $item->_invalid = 1;
			            continue;
		            } elseif ( bp_is_active( 'forums' ) && function_exists( 'bbp_is_subscriptions_active' ) && ! bbp_is_subscriptions_active() && 'bp-subscriptions-nav' === $item_class ) {
			            $item->_invalid = 1;
			            continue;
